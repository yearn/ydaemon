...
var CURVE_SUBGRAPHDATA_URI = map[uint64]string{
	1:     `https://api.curve.finance/v1/getBaseApys/ethereum`,
	10:    `https://api.curve.finance/v1/getBaseApys/optimism`,
	137:   `https://api.curve.finance/v1/getBaseApys/polygon`,
	250:   `https://api.curve.finance/v1/getBaseApys/fantom`,
	8453:  `https://api.curve.finance/v1/getBaseApys/base`,
	42161: `https://api.curve.finance/v1/getBaseApys/arbitrum`,
}
