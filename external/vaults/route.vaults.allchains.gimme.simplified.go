...
// GetAllGimmeVaultsForAllChainsSimplified will return a list of all v3 vaults for all chains
func (y Controller) GetAllGimmeVaultsForAllChainsSimplified(c *gin.Context) {
	/** 🔵 - Yearn *************************************************************************************
	...
	**************************************************************************************************/
	...
	for _, chainID := range chains {
		...
		for _, currentVault := range vaultsForChain {
			...
			******************************************************************************************/
			if !currentVault.Metadata.Inclusion.IsGimme {
				continue
			}
