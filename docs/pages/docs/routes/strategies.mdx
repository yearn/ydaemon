...
# Strategies API
The Strategies API allows you to query the strategies that are currently active on the Yearn's ecosystem. The API is available at https://ydaemon.yearn.finance/.
