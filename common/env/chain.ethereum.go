...
var ETHEREUM = TChain{
	...
	ExtraVaults: []models.TVaultsFromRegistry{
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0xA87958C4E0CFae74b6f7a158Ab639359cDf989bE`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0xCF7B325aEdDcb3DFDfa752e277c8e437Dd542828`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0x4e7Aa7085ef4651eE2270859C1702Fbe5A7Cf847`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0x17AfAB7686c088b0e2Feda46cFa7C656dB00a9C2`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0xb5ff5Da1ca2Ac2abd9dFABEe3b105CCe5A1eB057`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0xD1b0B6a1093A097227dc117C87AE3a72D9bd7Cf2`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0x29A7aDB4c69f697b6d9F04114175ae9989884926`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
		...
		{
			ChainID:         1,
			Address:         common.HexToAddress(`0x3bc9731dE20aa4fA7D6eb6bB84b359bE3F28D230`),
			RegistryAddress: common.HexToAddress(`0xff31A1B020c868F6eA3f61Eb953344920EeCA3af`),
			TokenAddress:    common.HexToAddress(`0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2`),
			APIVersion:      `3.0.1`,
			BlockNumber:     19237884,
