...
**************************************************************************************************/
func IndexVeYFIStakingContract(chainID uint64) (veYFIGaugesMap map[common.Address]common.Address) {
	...
	******************************************************************************************/
	...
	for i := int64(0); i < int64(numberOfGauges.Int64()); i++ {
		...
		storage.StoreVeYFIStaking(chainID, assetAddress, gaugeAddress)
	}
	...
	**********************************************************************************************/
	veYFIGaugesMap = storage.ListVeYFIStaking(chainID)
