...
// GetAllV3VaultsForAllChainsSimplified will return a list of all v3 vaults for all chains
func (y Controller) GetAllV3VaultsForAllChainsSeaSimplified(c *gin.Context) {
	/** 🔵 - Yearn *************************************************************************************
...
// GetAllV3VaultsForAllChainsSimplified will return a list of all v3 vaults for all chains
func (y Controller) GetAllV2VaultsForAllChainsSeaSimplified(c *gin.Context) {
	/** 🔵 - Yearn *************************************************************************************
	** orderBy: A string that determines the order in which the vaults are returned. It is obtained
	** from the 'orderBy' query parameter in the request. If the parameter is not provided,
	** it defaults to 'details.order'.
