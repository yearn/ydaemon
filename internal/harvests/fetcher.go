...
func RetrieveAllHarvestPerStrategyPerVault(chainID uint64) map[ethcommon.Address]map[ethcommon.Address][]THarvest {
	timeBefore := time.Now()
	/**********************************************************************************************
	...
	**********************************************************************************************/
	...
	go func() {
		...
		**********************************************************************************************/
		managementFees, performanceFees, strategiesPerformanceFees = retrieveAllFeesBPS(
			chainID,
			vaultsMap,
			strategiesMap,
		)
	...
	go func() {
		...
		**********************************************************************************************/
		vaults.RetrieveTresuryChange(chainID, vaultsMap)
