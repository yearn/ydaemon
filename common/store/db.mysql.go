...
func initializeMySQLDatabase() (shouldUseMySQLDB bool) {
	...
	if db != nil {
		...
		db.Table(`db_vaults_v2_price_per_share`).AutoMigrate(&DBHistoricalValue{})
		db.Table(`db_curve_virtual_prices`).AutoMigrate(&DBHistoricalValue{})
		db.AutoMigrate(&DBStrategy{})
		db.Table(`db_erc20`).AutoMigrate(&DBERC20{})
		db.AutoMigrate(&DBRegistrySync{})
		db.AutoMigrate(&DBStrategyAddedSync{})
