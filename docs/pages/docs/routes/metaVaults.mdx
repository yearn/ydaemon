...
#### Request
<Dropdown title={'Params'}>
	- **chainID**: The chainID of the chain you want to get the vault for. Must be provided in the URL, and must be one of the [supported](/docs/routes/getSupportedChains) chains.
