...
try {
  ...
  fs.copySync(path.join(DataDirectory, 'protocols'), path.join(OutDirectory, 'protocols'));
  fs.copySync(path.join(DataDirectory, 'tokens'), path.join(OutDirectory, 'tokens'));
  fs.copySync(path.join(DataDirectory, 'vaults'), path.join(OutDirectory, 'vaults'));
  fs.copySync(path.join(DataDirectory, 'strategies'), path.join(OutDirectory, 'strategies'));
